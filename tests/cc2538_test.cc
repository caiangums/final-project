// EPOS TI CC2538 IEEE 802.15.4 NIC<IEEE802_15_4> Mediator Test Program
...
bool led_value;
GPIO * led;
NIC<IEEE802_15_4>::Address peer;

int sender(NIC<IEEE802_15_4> * nic)
{
...
public:
    ...
    Receiver(const Protocol & p, NIC<IEEE802_15_4> * nic) : _prot(p), _nic(nic)
    {
...
private:
    Protocol _prot;
    NIC<IEEE802_15_4> * _nic;
};

int receive(NIC<IEEE802_15_4> * nic)
{
    CPU::int_enable();
    Receiver::data_type data[128];
    NIC<IEEE802_15_4>::Protocol prot;
    NIC<IEEE802_15_4>::Address from;
