...
#ifndef Machine_Engine_Engine_model_h
#define Machine_Engine_Engine_model_h
...
// UART
    unsigned int enable_uart(unsigned int unit) {
        ...
        if(unit == 0) {
            ...
            bool m95_enabled = Traits<M95>::enabled;
...
public:
    ...
    static volatile Reg32 & gpio(unsigned int port, unsigned int pin) { return reinterpret_cast<volatile Reg32 *>(GPIOA_BASE + (0x1000 * port))[(1 << pin) << 2 / sizeof(Reg32)]; }
