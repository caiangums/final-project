...
public:
    ...
    {
    public:
        Discover(const Ethernet::Address & mac, unsigned long xid) {
            _op = 1;
            _htype = 1;
            _hlen = sizeof(Ethernet::Address);
            _xid = xid;
            memcpy(_chaddr, &mac, sizeof(Ethernet::Address));
    ...
    {
    public:
        Request(const Ethernet::Address & mac, unsigned long xid, const Address & yiaddr, const Address & siaddr) {
            _op = 1;
            _htype = 1;
